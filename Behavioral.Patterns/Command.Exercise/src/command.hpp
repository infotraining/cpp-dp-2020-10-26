...
{
public:
    ClearCmd(Document& doc, CommandHistory& history) : UndoableCommandBase{history}, doc_{doc}
    {
    }
...
{
public:
    ToUpperCmd(Document& doc, CommandHistory& history) : UndoableCommandBase{history}, doc_{doc}
    {
    }
...
public:
    PasteCmd(Document& doc, Clipboard& clipboard_, CommandHistory& history)
        : UndoableCommandBase(history), doc_(doc), clipboard_(clipboard_)
    {
    }
...
{
public:
    UndoCmd(Console& console, CommandHistory& history) : console_{console}, history_(history)
    {
    }
...
public:
    AddTextCmd(Document& doc, Console& console, CommandHistory& history)
        : UndoableCommandBase(history), doc_{doc}, console_{console}
    {
    }
